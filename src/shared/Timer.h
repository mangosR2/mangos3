...
class WorldTimer
{
    ...
    private:
        ...
        static MANGOS_DLL_SPEC ACE_Atomic_Op<MANGOSR2_MUTEX_MODEL_2, uint32> m_iTime;
        static MANGOS_DLL_SPEC ACE_Atomic_Op<MANGOSR2_MUTEX_MODEL_2, uint32> m_iPrevTime;
};
