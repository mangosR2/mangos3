...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_FIX_MOVE_PACKETS_METHOD,
    CONFIG_UINT32_FIX_MOVE_PACKETS_ADD_TIME,
    CONFIG_UINT32_GUILD_DAILY_XP_CAP,
    CONFIG_UINT32_GUILD_MAX_LEVEL,
    CONFIG_UINT32_GUILD_WEEKLY_REP_CAP,
    CONFIG_UINT32_GUILD_EXPERIENCE_UNCAPPED_LEVEL,
    CONFIG_UINT32_GUILD_SAVE_INTERVAL,
...
enum eConfigFloatValues
{
    ...
    CONFIG_FLOAT_RATE_GUILD_REPUTATION_GAIN,
    ...
    CONFIG_FLOAT_RATE_HONOR_RANDOMBG,
    ...
    CONFIG_FLOAT_MELEE_DIST_ADDITION,
    CONFIG_FLOAT_RATE_GUILD_XP_MODIFIER,
    CONFIG_FLOAT_ARCHAEOLOGY_RARE_BASE_CHANCE,
    CONFIG_FLOAT_ARCHAEOLOGY_RARE_MAXLEVEL_CHANCE,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_INSTANCE_ALLOW_OBJECT_SPAWNING,
    ...
    CONFIG_BOOL_ARCHAEOLOGY_ENABLED,
