...
{
    FillInitialWorldState(BG_TP_FLAG_CAPTURES_ALLIANCE, m_TeamScores[TEAM_INDEX_ALLIANCE]);
    FillInitialWorldState(BG_TP_FLAG_CAPTURES_HORDE, m_TeamScores[TEAM_INDEX_HORDE]);
