...
enum BG_EY_CapturePoints
{
    BG_EY_CP_FEL_REAVER         = 184081,
    BG_EY_CP_BLOOD_ELF          = 184080,
    BG_EY_CP_DRAENEI_RUINS      = 184083,
    BG_EY_CP_MAGE_TOWER         = 184082,
    BG_EY_CP_BANNER_NEUTRAL     = 184382,
    BG_EY_CP_BANNER_ALLIANCE    = 184381,
    BG_EY_CP_BANNER_HORDE       = 184380,
};

enum BG_EY_CaptureEvents
{
    BG_EY_CP_EVENT_FELREAVER_CAPTURE_ALLIANCE   = 12969,
    BG_EY_CP_EVENT_FELREAVER_CAPTURE_HORDE      = 12968,
    BG_EY_CP_EVENT_FELREAVER_PROGRESS_ALLIANCE  = 12911,
    BG_EY_CP_EVENT_FELREAVER_PROGRESS_HORDE     = 12910,
    BG_EY_CP_EVENT_FELREAVER_LOSE_ALLIANCE      = 12960,
    BG_EY_CP_EVENT_FELREAVER_LOSE_HORDE         = 12961,

    BG_EY_CP_EVENT_BLOODELF_CAPTURE_ALLIANCE    = 12965,
    BG_EY_CP_EVENT_BLOODELF_CAPTURE_HORDE       = 12964,
    BG_EY_CP_EVENT_BLOODELF_PROGRESS_ALLIANCE   = 12905,
    BG_EY_CP_EVENT_BLOODELF_PROGRESS_HORDE      = 12904,
    BG_EY_CP_EVENT_BLOODELF_LOSE_ALLIANCE       = 12957,
    BG_EY_CP_EVENT_BLOODELF_LOSE_HORDE          = 12956,

    BG_EY_CP_EVENT_DRAENEI_CAPTURE_ALLIANCE     = 12967,
    BG_EY_CP_EVENT_DRAENEI_CAPTURE_HORDE        = 12966,
    BG_EY_CP_EVENT_DRAENEI_PROGRESS_ALLIANCE    = 12907,
    BG_EY_CP_EVENT_DRAENEI_PROGRESS_HORDE       = 12906,
    BG_EY_CP_EVENT_DRAENEI_LOSE_ALLIANCE        = 12958,
    BG_EY_CP_EVENT_DRAENEI_LOSE_HORDE           = 12959,

    BG_EY_CP_EVENT_MAGE_CAPTURE_ALLIANCE        = 12971,
    BG_EY_CP_EVENT_MAGE_CAPTURE_HORDE           = 12970,
    BG_EY_CP_EVENT_MAGE_PROGRESS_ALLIANCE       = 12909,
    BG_EY_CP_EVENT_MAGE_PROGRESS_HORDE          = 12908,
    BG_EY_CP_EVENT_MAGE_LOSE_ALLIANCE           = 12962,
    BG_EY_CP_EVENT_MAGE_LOSE_HORDE              = 12963,
};
