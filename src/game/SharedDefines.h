...
enum SpellAttributesEx4
{
    ...
    SPELL_ATTR_EX4_NOT_USABLE_IN_ARENA_OR_RATED_BG=0x00010000,          // 16 not usable in arena or rated bg
...
enum SpellAttributesEx9
{
    ...
    SPELL_ATTR_EX9_NOT_USABLE_IN_ARENA         = 0x00000200,            // 9
    ...
    SPELL_ATTR_EX9_USABLE_IN_RATED_BATTLEGROUNDS = 0x00004000,          // 14
...
#define IMMUNE_TO_MOVEMENT_IMPAIRMENT_AND_LOSS_CONTROL_MASK ( \
    ...
    (1<<(MECHANIC_DAZE    -1))|(1<<(MECHANIC_SAPPED     -1))|(1<<(MECHANIC_SILENCE-1)))
...
#define MECHANIC_NOT_REMOVED_BY_SHAPESHIFT ( \
    ...
    (1<<(MECHANIC_DAZE   -1))|(1<<(MECHANIC_SAPPED     -1))|(1<<(MECHANIC_PACIFY-1))| \
    (1<<(MECHANIC_ROOT   -1))|(1<<(MECHANIC_POLYMORPH  -1)))
...
enum CreatureFamily
{
    ...
    CREATURE_FAMILY_BEETKE_ZZOLD   = 57,
