...
void InitializeOpcodes()
{
    ...
    OPCODE(CMSG_LFG_GET_STATUS,                          STATUS_UNHANDLED,PROCESS_INPLACE,      &WorldSession::HandleLfgGetStatus      );
    OPCODE(CMSG_DUNGEON_FINDER_GET_SYSTEM_INFO,          STATUS_UNHANDLED,PROCESS_INPLACE,      &WorldSession::HandleLfgPlayerLockInfoRequestOpcode );
