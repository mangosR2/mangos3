...
void InitializeOpcodes()
{
    ...
    OPCODE(CMSG_LFG_GET_STATUS,                          STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::HandleLfgGetStatus      );
    OPCODE(CMSG_DUNGEON_FINDER_GET_SYSTEM_INFO,          STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::HandleLfgPlayerLockInfoRequestOpcode );
    ...
    OPCODE(CMSG_GUILD_ACHIEVEMENT_PROGRESS_QUERY,        STATUS_LOGGEDIN, PROCESS_THREADUNSAFE, &WorldSession::HandleGuildAchievementProgressQuery);
