...
void InitializeOpcodes()
{
    ...
    OPCODE(CMSG_BATTLEFIELD_MANAGER_ENTRY_INVITE_RESPONSE,STATUS_LOGGEDIN,PROCESS_INPLACE,      &WorldSession::HandleBfEntryInviteResponse     );
    ...
    OPCODE(CMSG_BATTLEFIELD_MANAGER_QUEUE_INVITE_RESPONSE,STATUS_LOGGEDIN,PROCESS_INPLACE,      &WorldSession::HandleBfQueueInviteResponse     );
    OPCODE(CMSG_BATTLEFIELD_MANAGER_QUEUE_REQUEST,       STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::HandleBfQueueRequest            );
    ...
    OPCODE(CMSG_BATTLEFIELD_MANAGER_EXIT_REQUEST,        STATUS_LOGGEDIN, PROCESS_INPLACE,      &WorldSession::HandleBfExitRequest             );
