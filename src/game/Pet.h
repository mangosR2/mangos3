...
class MANGOS_DLL_SPEC Pet : public Creature
{
    public:
        ...
        bool LoadPetFromDB(Player* owner, uint32 petentry = 0, uint32 petnumber = 0, bool current = false, CreatureCreatePos* pos = NULL, PetSaveMode slot = PET_SAVE_NOT_IN_SLOT);
