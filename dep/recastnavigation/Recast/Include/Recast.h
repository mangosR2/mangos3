...
struct rcSpan
{
	unsigned int smin : 16;			///< The lower limit of the span. [Limit: < #smax] // EDITED BY TC
	unsigned int smax : 16;			///< The upper limit of the span. [Limit: <= #RC_SPAN_MAX_HEIGHT] // EDITED BY TC
	unsigned char area;			    ///< The area id assigned to the span. // EDITED BY TC
