...
#define GIT_REV_PREFIX "sd2_mr"
#define GIT_REV_PRINT  GIT_REV_PREFIX "%04d"
#define GIT_REV_FORMAT "[" GIT_REV_PRINT "]"

char remotes[NUM_REMOTES][MAX_REMOTE] = {
    "git@github.com:mangosR2/scriptdev2.git",
    "git://github.com/mangosR2/scriptdev2.git"                       // used for fetch if present
};

char remote_branch[MAX_REMOTE] = "master";
char rev_nr_file[MAX_PATH] = "sd2_revision_R2.h";
...
std::string generateNrHeader(char const* rev_str)
{
    ...
    newData << "#ifndef __SD2_REVISION_R2_H__" << std::endl;
    newData << "#define __SD2_REVISION_R2_H__"  << std::endl;
    newData << " #define SD2_REVISION_R2 \"" << rev_str << "\"" << std::endl;
    newData << "#endif // __SD2_REVISION_R2_H__" << std::endl;
    return newData.str();
}
