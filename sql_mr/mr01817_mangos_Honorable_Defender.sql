DELETE FROM creature_template_addon WHERE entry IN (35379, 35380, 36349, 36350);
INSERT INTO creature_template_addon (entry, auras) VALUES
(35379, 66157), -- eye of storm alliance
(35380, 66157), -- eye of storm horde
(36349, 68652), -- arathi basin alliance
(36350, 68652); -- arathi basin horde

UPDATE creature_template SET FactionAlliance = 534, FactionHorde = 534, UnitFlags = 0x2000202 WHERE entry IN (35379, 36349); -- ally
UPDATE creature_template SET FactionAlliance = 714, FactionHorde = 714, UnitFlags = 0x2000202 WHERE entry IN (35380, 36350); -- horde

-- new positions in arathi basin
DELETE FROM creature WHERE id IN (35379, 35380, 36349, 36350);
INSERT INTO creature (guid, id, map, spawnMask, phaseMask, position_x, position_y, position_z, spawntimesecs, spawndist) VALUES
